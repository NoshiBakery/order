  ...
  function buildReceiptInner(order) {
    ...
    const rows = items.map((item) => {
      ...
      const individualDiscountHtml = individual > 0
        ? `<tr><td colspan="3" style="text-align:right;font-size:11px;color:#a44848;padding:0 0 5px;font-weight:700;">🏷️ خصم ${money(individual)}% — بعد الخصم ${money(lineAfter)} ر.س</td></tr>`
        : "";
      return `
        <tr>
