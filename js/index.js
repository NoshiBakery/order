...
// ملاحظة صيانة: لا يوجد توزيع ذكي في تقسيم التسليم.
// رسوم كل موعد والمنتجات داخله يحددها المستخدم يدويًا فقط.
...
function openSplitDeliveryPlanner() {
  ...
  style.textContent = `
    ...
    #splitDeliveryPlanner .sp-fields{display:grid;grid-template-columns:minmax(150px,.9fr) minmax(120px,.72fr) minmax(82px,.42fr);gap:7px;align-items:end}.sp-field{font-size:11px;font-weight:850;color:#514b58}.sp-field input,.sp-field select{display:block;width:100%;height:36px;margin-top:4px;border:1px solid #ddd8e2;border-radius:9px;background:#fff;padding:4px 7px;font:700 11px -apple-system,BlinkMacSystemFont,'Segoe UI',Tahoma,Arial,sans-serif;color:#27232c;outline:none}.sp-field input[type=datetime-local]{font-size:10px;padding-inline:4px}.sp-field input:focus,.sp-field select:focus{border-color:#8b78e6;box-shadow:0 0 0 2px rgba(139,120,230,.10)}
    ...
    @media(max-width:640px){#splitDeliveryPlanner{padding:0;align-items:flex-end}#splitDeliveryPlanner .sp-panel{width:100%;max-width:none;max-height:96dvh;border-radius:24px 24px 0 0;padding:12px 10px max(12px,env(safe-area-inset-bottom))}.sp-fields{grid-template-columns:minmax(0,1.25fr) minmax(0,.9fr) minmax(74px,.55fr)!important;gap:5px!important}.sp-field{font-size:10px!important}.sp-field input,.sp-field select{height:33px!important;font-size:10px!important;padding:3px 5px!important}.sp-products{grid-template-columns:repeat(3,minmax(0,1fr))!important}.sp-unit-name{font-size:10.5px!important}.sp-drop{min-height:102px!important}}
  `;
