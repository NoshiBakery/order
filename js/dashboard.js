  ...
  function render(){
    ...
    list.innerHTML=orders.map(o=>{
      ...
      return `<article class="card" data-id="${esc(o.id)}">
        ...
        ${pot?`<div style="margin:12px 0;padding:12px;border-radius:12px;background:#fff3cd;border:1px solid #ead28b;color:#6b5516"><b>⚠️ يرجى التحقق من رقم الجوال قبل قبول الطلب</b><div style="margin-top:5px">عميلة محتملة: <b>${esc(pot.client.name)}</b> · الاختلاف ${pot.diff===1?'رقم واحد':'رقمين'}</div></div>`:''}
